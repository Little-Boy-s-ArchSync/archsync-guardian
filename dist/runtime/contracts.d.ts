export declare const runtimeEvidenceContractVersion: "0.1";
export declare const runtimeCollectorVersion: "0.1.0-foundation";
...
export interface ObservedRuntimeGraph {
    ...
    signals: Array<{
        code: "RUNTIME_MAPPING_AMBIGUOUS" | "RUNTIME_MAPPING_MISSING" | "RUNTIME_LOW_SAMPLE" | "RUNTIME_UNDECLARED_EDGE" | "RUNTIME_NO_EVIDENCE";
