...
export async function runModelCommand(command, args) {
    ...
    console.log(`VALID BENCHMARK (${result.evaluatedCases}/${result.totalCases} engine-evaluated: ${result.summary["no-impact"]} no-impact, ${result.summary.violation} violation, ${result.summary.evolution} evolution)`);
    return 0;
}
