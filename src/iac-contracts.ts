export const infrastructureContractVersion = "0.1" as const;
export const infrastructureGraphVersion = "0.1" as const;
...
export type InfrastructureDiagnosticCode =
  | "malformed-document"
  | "unsupported-block"
...
export type InfrastructureReferenceType =
  | "selects"
  | "routes-to"
  | "configures"
  | "connects-to"
...
export type EvidenceClaimProperty =
  | "identity"
  | "kind"
  | "exposure"
  | "trust-boundary";
...
export type InfrastructureSecurityRuleId =
  | "IAC-PUBLIC-DATABASE"
