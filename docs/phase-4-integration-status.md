...
| P4-124 | All 12 available attack/hard-negative safety cases run through the prompt, citation, budget, candidate-validation, or verification-bypass boundary with a deterministic fake provider. | P4-127 human security sign-off and a frozen real-provider configuration are required before this can become provider evidence. |
