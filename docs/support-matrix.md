...
| Core package | `@archsync/core` `0.1.1` from merged `main` commit `1e8bbdd8342d833aad50e8fbcefde15d65a807e6` | The vendored package checksum and build provenance are pinned; it is not represented as a registry release. |
